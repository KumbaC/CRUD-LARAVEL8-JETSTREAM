...
<div class="min-h-screen bg-gray-100">
    ...
    <center><div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        <div class="col-span-2 lg:col-span-1">
            <h1 class="max-w-3xl py-2 mx-auto text-5xl font-bold text-center text-gray-800 md:text-6xl dark:text-white">Actualizar Productos</h1>
